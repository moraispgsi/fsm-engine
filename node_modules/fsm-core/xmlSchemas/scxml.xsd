...
<!-- NEW ELEMENTS -->
    <!-- logme-->
    <xsd:attributeGroup name="scxml.logme.attlist">
        <xsd:attribute name="label" type="xsd:string"/>
        <xsd:attribute name="expr" type="ValueLang.datatype"/>
        <xsd:attributeGroup ref="scxml.extra.attribs"/>
    </xsd:attributeGroup>
    <xsd:group name="scxml.logme.content">
        <xsd:sequence>
            <xsd:group maxOccurs="unbounded" minOccurs="0" ref="scxml.extra.content"/>
        </xsd:sequence>
    </xsd:group>
    <xsd:complexType name="scxml.logme.type">
        <xsd:group ref="scxml.logme.content"/>
        <xsd:attributeGroup ref="scxml.logme.attlist"/>
    </xsd:complexType>
    <xsd:element name="logme" type="scxml.logme.type"/>
